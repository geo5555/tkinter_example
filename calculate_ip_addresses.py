...
txtSubnet = Entry(window, width=20)
txtSubnet.insert(0, "10.36.64.0/22")
txtSubnet.grid(column=0, row=1)
txtWanIP = Entry(window, width=20)
txtWanIP.insert(0, "172.16.34.66")
txtWanIP.grid(column=0, row=2)
txtHostname = Entry(window, width=20)
txtHostname.insert(0, "rtr1213")
txtHostname.grid(column=0, row=3)
txtTunnel20 = Entry(window, width=20)
txtTunnel20.insert(0, "10.12.12.13")
txtTunnel20.grid(column=0, row=4)
choices = ['1Mb', '2MB', '4MB', '6MB', '10Mb', '15Mb', '20Mb']
bw1 = Combobox(window, values=choices)
bw1.grid(column=0, row=6)
txtArea1 = scrolledtext.ScrolledText(window, width=50, height=80)
txtArea1.grid(column=0, row=7)
txtArea2 = scrolledtext.ScrolledText(window, width=80, height=80)
txtArea2.grid(column=1, row=7)
